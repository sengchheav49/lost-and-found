...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Item item) {
            ...
            // Set type style based on lost/found status
            int styleRes = item.getItemType().equals("lost") ?
                    R.style.LostItemLabel : R.style.FoundItemLabel;
            tvItemType.setTextAppearance(context, styleRes);
        ...
        public void onClick(View v) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                intent.putExtra("date", new SimpleDateFormat(DATE_FORMAT, Locale.getDefault()).format(item.getDate()));
